...
def is_help_command(user_input):
    ...
    if user_input_upper == 'H' or user_input_upper == 'HELP':
        result = True
    return result
    # ==================================
...
def is_validated_english_sentence(user_input):
    ...
    p3 = re.compile(r"[\.\,\!\?]")
    p4 = re.compile(r"\s*")
    if p1.search(user_input):
        result = False
    if p2.search(user_input):
        result = False
    after_p3 = p3.sub('',user_input)
    if p4.fullmatch(after_p3):
        result = False
    return result
...
def decoding_character(morse_character):
    ...
    result = None
    switch_morse = dict(zip(morse_code_dict.values(),morse_code_dict.keys()))
    result = switch_morse[morse_character]
    return result
    # ==================================
...
if __name__ == "__main__":
    ...
    # print(get_cleaned_english_sentence('hello?! '))
    # print(decoding_character('-.-'))
    # print(encoding_character('k'))
